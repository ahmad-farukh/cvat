...
import ClassWiseAnalyticsPage from './class-wise-analytics/class-wise-analytics-page';
                            ...
                            <Layout>
                                ...
                                <Layout.Content style={{ height: '100%', position: 'relative' }}>
                                    ...
                                    <Switch>
                                        ...
                                        <Route exact path='/class-wise-analytics' component={ClassWiseAnalyticsPage} />
