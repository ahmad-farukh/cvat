...
/* harmony import */ var lru_cache__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lru-cache */ "../node_modules/lru-cache/dist/esm/index.min.js");
/* harmony import */ var cvat_core_wrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! cvat-core-wrapper */ "./src/cvat-core-wrapper.ts");
/* harmony import */ var _inference_worker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inference.worker */ "./plugins/sam/src/ts/inference.worker.ts");
...
function buildROISignature(roi) {
  return roi ? `${roi[0]}_${roi[1]}_${roi[2]}_${roi[3]}` : 'full';
}
function optTranslatePrompts(points, roi) {
...
const samPlugin = {
  ...
  cvat: {
    jobs: {
      get: {
        async leave(plugin, results, query) {
      ...
      call: {
            ...
            if (model.id === plugin.data.modelID) {
              if (!plugin.data.initialized) {
                samPlugin.data.worker.postMessage({
                  action: _inference_worker__WEBPACK_IMPORTED_MODULE_2__.WorkerAction.INIT,
                  payload: {
                    decoderURL: samPlugin.data.modelURL
                  }
                });
                samPlugin.data.worker.onmessage = e => {
                  if (e.data.action !== _inference_worker__WEBPACK_IMPORTED_MODULE_2__.WorkerAction.INIT) {
        ...
        async leave(plugin, result, taskID, model, {
          ...
          return new Promise((resolve, reject) => {
            ...
            const job = Object.values(plugin.data.jobs).find(_job => _job.taskId === taskID && frame >= _job.startFrame && frame <= _job.stopFrame);
            if (!job) {
            ...
            job.frames.get(frame).then(({
              ...
              const isLowResMaskRelevant = JSON.stringify(clicks.slice(0, -1)) === JSON.stringify(plugin.data.lastClicks);
              plugin.data.worker.postMessage({
                action: _inference_worker__WEBPACK_IMPORTED_MODULE_2__.WorkerAction.DECODE,
                payload: modelData({
                  imageEmbeddings: plugin.data.embeddings.get(key),
                  lowResMask: isLowResMaskRelevant ? plugin.data.lowResMasks.get(key) ?? null : null,
                  modelScale: {
                    width: inputWidth,
                    height: inputHeight,
              ...
              plugin.data.worker.onmessage = e => {
                if (e.data.action !== _inference_worker__WEBPACK_IMPORTED_MODULE_2__.WorkerAction.DECODE) {
                  const msg = 'Caught unexpected action response from worker: ' + `${e.data.action}, while "${_inference_worker__WEBPACK_IMPORTED_MODULE_2__.WorkerAction.DECODE}" expected`;
                  ...
                  resolve({
                    shapes: payload.map(item => {
                      ...
                      return {
                        points: rle,
                        group: 0,
                        source: cvat_core_wrapper__WEBPACK_IMPORTED_MODULE_1__.Source.SEMI_AUTO,
                        occluded: false,
                        rotation: 0,
                        type: cvat_core_wrapper__WEBPACK_IMPORTED_MODULE_1__.ShapeType.MASK,
                        attributes: []
                      };
                    })
                  });
  ...
  data: {
    initialized: false,
    core: null,
    worker: new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("plugins_sam_src_ts_inference_worker_ts"), __webpack_require__.b)),
    jobs: {},
    modelID: 'pth-facebookresearch-sam-vit-h',
    modelURL: '/assets/decoder.onnx',
    embeddings: new lru_cache__WEBPACK_IMPORTED_MODULE_0__.LRUCache({
      // float32 tensor [256, 64, 64] is 4 MB, max 128 MB
      max: 32,
      updateAgeOnGet: true,
      updateAgeOnHas: true
    }),
    lowResMasks: new lru_cache__WEBPACK_IMPORTED_MODULE_0__.LRUCache({
...
function register() {
  if (Object.prototype.hasOwnProperty.call(window, 'cvatUI')) {
    window.cvatUI.registerComponent(builder);
  }
}
...
/***/ "./plugins/sam/src/ts/inference.worker.ts"
/*!************************************************!*\
  !*** ./plugins/sam/src/ts/inference.worker.ts ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! onnxruntime-web */ "../node_modules/onnxruntime-web/dist/ort.bundle.min.mjs?f135");
// Copyright (C) CVAT.ai Corporation
//
// SPDX-License-Identifier: MIT
...
let decoder = null;
onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.env.wasm.wasmPaths = '/assets/';
let WorkerAction = /*#__PURE__*/function (WorkerAction) {
  WorkerAction["INIT"] = "init";
  WorkerAction["DECODE"] = "decode";
  return WorkerAction;
}({});
...
if (self.importScripts) {
  onmessage = e => {
    if (e.data.action === WorkerAction.INIT) {
      ...
      onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.InferenceSession.create(body.decoderURL).then(decoderSession => {
      ...
      const body = e.data.payload;
      const inputs = {
        image_embeddings: new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', body.imageEmbeddings, [1, 256, 64, 64]),
        point_coords: new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', body.pointCoords, [1, body.pointCoords.length / 2, 2]),
        point_labels: new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', body.pointLabels, [1, body.pointLabels.length]),
        orig_im_size: new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', [body.height, body.width]),
        mask_input: body.maskInput ? new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', body.maskInput, [1, 1, 256, 256]) : new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', new Float32Array(256 * 256), [1, 1, 256, 256]),
        has_mask_input: new onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.Tensor('float32', [body.maskInput ? 1 : 0])
      };
      decoder.run(inputs).then(results => Promise.all([results.xtl.getData(), results.ytl.getData(), results.xbr.getData(), results.ybr.getData(), results.masks.getData(), results.low_res_masks.getData()])).then(([xtl, ytl, xbr, ybr, mask, lowResMask]) => {
        postMessage({
          action: WorkerAction.DECODE,
          payload: [{
            mask_input: lowResMask,
            points: new Uint8ClampedArray(mask.buffer, mask.byteOffset, mask.length),
            bounds: [Number(xtl[0]), Number(ytl[0]), Number(xbr[0]), Number(ybr[0])]
          }]
        });
      }).catch(error => {
        postMessage({
...
module.exports = __webpack_require__.p + "9b38a8c18d5f4d131491.wasm";

/***/ },

/***/ "../node_modules/onnxruntime-web/dist/ort.bundle.min.mjs?ed2d"
/*!***************************************************************!*\
  !*** ../node_modules/onnxruntime-web/dist/ort.bundle.min.mjs ***!
  \***************************************************************/
(module, __unused_webpack_exports, __webpack_require__) {

module.exports = __webpack_require__.p + "07c163c143c890476ddc.mjs";

/***/ },

/***/ "../node_modules/onnxruntime-web/dist/ort.bundle.min.mjs?f135"
/*!***************************************************************!*\
  !*** ../node_modules/onnxruntime-web/dist/ort.bundle.min.mjs ***!
  \***************************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   InferenceSession: () => (/* binding */ Kp),
/* harmony export */   TRACE: () => (/* binding */ $r),
/* harmony export */   TRACE_EVENT_BEGIN: () => (/* binding */ wt),
/* harmony export */   TRACE_EVENT_END: () => (/* binding */ vt),
...
/* harmony export */   registerBackend: () => (/* binding */ Pt)
/* harmony export */ });
/*!
...
/******/ var __webpack_exports__ = (__webpack_exec__("./plugins/sam/src/ts/index.tsx"));
/******/ }
]);
//# sourceMappingURL=plugin_0.0fe65f8c89eca2d75db8.min.js.map